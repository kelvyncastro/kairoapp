...
export default function AppLayout() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      ...
      >
        {/* Topbar */}
        <header className="sticky top-0 z-30 flex h-14 items-center justify-between md:justify-end border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 md:px-6">
          {/* Mobile menu button */}
